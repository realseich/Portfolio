...
|---|---|---|---|
|[EdTech-bisiness-course-ordering-improvments---SQL-Python-Pandas](https://github.com/realseich/Complex-task--SQL-Python)|For EdTech business: Analysis of the courseses combinations which have been ordered, to setup a base for system which recommends additional courses during course ordering procedure.<br />Final class project.| Для EdTech компании: Разработка основы системы, рекомендующей дополнительные курсы при онлайн-заказе на базе анализа популярности сочетаний курсов.<br />Учебный проект.|PostgreSQL,<br />Python with Pandas<br />(Jupyter Notebook)|
